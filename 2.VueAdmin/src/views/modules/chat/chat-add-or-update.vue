<template>
  <div :style='{"color":"#3B3E40","padding":"30px 30px 30px","fontSize":"14px"}'>
    ...
    >
      ...
      <div class="clear-float"></div>
      <el-form-item :style='{"border":"0px solid #eee","padding":"0px 0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","background":"none","width":"100%","fontSize":"inherit"}' label="回复" prop="reply">
