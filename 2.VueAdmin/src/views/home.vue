<template>
<div class="content" :style='{"minHeight":"100vh","padding":"30px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231118/2c74c7b9c976472299f0bf82ecffc97d.png) no-repeat center top / cover","display":"flex","fontSize":"14px","height":"auto"}'>
	<!-- notice -->
	<!-- title -->
	<div class="text" :style='{"width":"100%","margin":"0px auto 40px","fontSize":"32px","color":"rgb(51, 51, 51)","textAlign":"center","fontWeight":"600"}'>欢迎使用 {{this.$project.projectName}}</div>
	<!-- statis -->
	<div :style='{"border":"0px solid #e3e3e3","padding":"0px","margin":"0 0 30px","alignItems":"center","color":"#5daced","display":"block","justifyContent":"space-between","borderRadius":"5px","flexWrap":"wrap","background":"none","flex":"1","width":"49%","fontSize":"14px","order":"0"}'>
		<div :style='{"padding":"16px 10px","margin":"0 2% 12px 0","borderColor":"#e3e3e3","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"center","borderRadius":"5px","background":"#fff","borderWidth":"1px","width":"48%","borderStyle":"solid"}' v-if="isAuth('yonghu','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#6bccc9","display":"none","width":"50px","justifyContent":"center","height":"50px"}'>
				<span class="icon iconfont icon-touxiang05" :style='{"color":"#fff","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","margin":"0 0 0 20px","textAlign":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"42px","color":"inherit","fontWeight":"500","height":"24px"}'>{{yonghuCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"#666","height":"24px"}'>用户总数</div>
			</div>
		</div>
		<div :style='{"padding":"16px 10px","margin":"0 2% 12px 0","borderColor":"#e3e3e3","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"center","borderRadius":"5px","background":"#fff","borderWidth":"1px","width":"48%","borderStyle":"solid"}' v-if="isAuth('peicaixinxi','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#fc6c60","display":"none","width":"50px","justifyContent":"center","height":"50px"}'>
				<span class="icon iconfont icon-qita6" :style='{"color":"#fff","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","margin":"0 0 0 20px","textAlign":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"42px","color":"inherit","fontWeight":"500","height":"24px"}'>{{peicaixinxiCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"#666","height":"24px"}'>配菜信息总数</div>
			</div>
		</div>
		<div :style='{"padding":"16px 10px","margin":"0 2% 12px 0","borderColor":"#e3e3e3","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"center","borderRadius":"5px","background":"#fff","borderWidth":"1px","width":"48%","borderStyle":"solid"}' v-if="isAuth('toupiaohuodong','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"#f6d346","display":"none","width":"50px","justifyContent":"center","height":"50px"}'>
				<span class="icon iconfont icon-chujia3" :style='{"color":"#fff","fontSize":"32px"}'></span>
			</div>
			<div :style='{"width":"auto","margin":"0 0 0 20px","textAlign":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"42px","color":"inherit","fontWeight":"500","height":"24px"}'>{{toupiaohuodongCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"#666","height":"24px"}'>投票活动总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<div class="type3" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"10"}'>
		<div id="peicaixinxiChart1" class="echarts1" v-if="isAuth('peicaixinxi','首页统计')"></div>
		<div id="peicaixinxiChart2" class="echarts2" v-if="isAuth('peicaixinxi','首页统计')"></div>
		<div id="toupiaohuodongChart1" class="echarts3" v-if="isAuth('toupiaohuodong','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
	...
	mounted(){
		this.init();
		this.getyonghuCount();
		this.getpeicaixinxiCount();
		this.peicaixinxiChat1();
		this.peicaixinxiChat2();
		this.gettoupiaohuodongCount();
		this.toupiaohuodongChat1();
	},
	methods:{
		// 统计图动画
		...
		getpeicaixinxiCount() {
			this.$http({
				url: `peicaixinxi/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.peicaixinxiCount = data.data
				}
			})
		},
// 1234 竖
        ...
        var peicaixinxiChart1 = echarts.init(document.getElementById("peicaixinxiChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                peicaixinxiChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    peicaixinxiChart1.resize();
                };
            }
        });
      })
    ...
    peicaixinxiChat2() {
      this.$nextTick(()=>{
        ...
        var peicaixinxiChart2 = echarts.init(document.getElementById("peicaixinxiChart2"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                peicaixinxiChart2.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    peicaixinxiChart2.resize();
                };
            }
        });
      })
		...
		gettoupiaohuodongCount() {
			this.$http({
				url: `toupiaohuodong/count`,
				method: "get"
			}).then(({
				data
			}) => {
				if (data && data.code == 0) {
					this.toupiaohuodongCount = data.data
				}
			})
		},
// 1234 折面
        ...
        var toupiaohuodongChart1 = echarts.init(document.getElementById("toupiaohuodongChart1"),'macarons');
        this.$http({
            url: `toupiaohuodong/value/toupiaomingcheng/suodepiaoshu`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                for(let i=0;i<res.length;i++){
                    ...
                    xAxis.push(res[i].toupiaomingcheng);
                    yAxis.push(parseFloat((res[i].total)));
                    pArray.push({
                        value: parseFloat((res[i].total)),
                        name: res[i].toupiaomingcheng
                    })
                }
                var option = {};
				let titleObj = this.line.title
				titleObj.text = '投票票数统计'
                ...
                // 使用刚指定的配置项和数据显示图表。
                toupiaohuodongChart1.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    toupiaohuodongChart1.resize();
                };
            }
        });
      })
