<template>
	<div :style='{"padding":"20px 20px 20px","margin":"0 auto","borderColor":"#d3d3d3","alignItems":"flex-start","flexWrap":"wrap","background":"#fff","borderWidth":"0 1px","display":"flex","width":"980px","position":"relative","borderStyle":"solid","justifyContent":"space-between"}'>
	<el-button :style='{"border":"1px solid #1abc9e30","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#1abc9e","borderRadius":"0px","background":"none","width":"auto","lineHeight":"34px","fontSize":"14px","height":"34px"}' type="warning" size="mini" @click="backClick" class="el-icon-back">返回</el-button>
	<div :style='{"width":"100%","overflow":"hidden","flexWrap":"wrap","background":"#fff","justifyContent":"space-between","display":"flex"}'>
		...
		<div :style='{"width":"calc(100% - 0px)","padding":"0px","position":"relative","background":"none","order":"1"}'>
			<div  :style='{"margin":"0 0 10px","lineHeight":"40px","fontSize":"16px","color":"#222","textAlign":"center","fontWeight":"600"}'>{{detail.title}}</div>
			...
			<div class="operate" :style='{"padding":"10px 0px","alignItems":"center","color":"#666","display":"flex","width":"100%","fontSize":"13px","justifyContent":"flex-end"}'>
			...
			<div :style='{"border":"0px solid #eee","padding":"0","margin":"20px 0 0","color":"#888","width":"100%","fontSize":"14px","lineHeight":"1.8","textIndent":"2em","height":"auto"}' class="content-detail" v-html="detail.content"></div>
		</div>
		<!-- option -->
		<div :style='{"width":"calc(100% - 0px)","padding":"0 0px","margin":"20px 0","display":"flex","height":"auto","order":"2"}'>
		...
		<div class="hot" :style='{"width":"100%","margin":"0px auto","background":"#fff","height":"auto","order":"13"}'>
		  <div :style='{"padding":"0 0 0 34px","borderColor":"#c20c0c","color":"#4a576a","borderRadius":"0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20240124/c18108dd98c34cdbab5fc0b1ed2dd781.png) no-repeat 10px center","borderWidth":"0 0 2px","width":"100%","lineHeight":"34px","fontSize":"20px","borderStyle":"solid"}'>热门文章</div>
