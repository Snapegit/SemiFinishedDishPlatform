<template>
<div class="forum-preview" :style='{"minHeight":"500px","padding":"20px 20px 40px","margin":"0px auto","borderColor":"#d3d3d3","background":"#fff","borderWidth":"0 1px","width":"980px","position":"relative","borderStyle":"solid"}'>
    <div :style='{"padding":"30px 0 0","margin":"0px auto 0","borderColor":"#ffc652","textAlign":"center","background":"none","borderWidth":"0px 0 0","width":"100%","borderStyle":"solid","height":"60px"}'>
		<div :style='{"padding":"0 20px","color":"#222","textAlign":"center","background":"none","display":"inline-block","width":"auto","fontSize":"22px","fontWeight":"500"}'>互动交流</div>
	</div>
...
<style rel="stylesheet/scss" lang="scss" scoped>
  ...
  .section-btn {
	...
	.forum-preview .el-form-item ::v-deep .el-form-item__content {
				display: flex;
				align-items: center;
			}
	
	.forum-preview .el-form-item .el-input ::v-deep .el-input__inner {
