		...
		<div class="attr" :style='{"padding":"0","margin":"0","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"calc(100% - 230px)","position":"relative","justifyContent":"space-between","order":"2"}'>
			...
			<div class="info" :style='{"padding":"0px","margin":"0","borderRadius":"0px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","order":"2"}'>
				...
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","alignItems":"flex-start","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					...
					<div  :style='{"padding":"0px 10px 0","overflow":"hidden","whiteSpace":"nowrap","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","textOverflow":"ellipsis","height":"auto"}'>{{detail.username}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","alignItems":"flex-start","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>角色</div>
					<div  :style='{"padding":"0px 10px 0","overflow":"hidden","whiteSpace":"nowrap","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","textOverflow":"ellipsis","height":"auto"}'>{{detail.role}}</div>
				</div>
				<div class="btn" :style='{"width":"100%","padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"1px solid #009cf530","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#009cf5","borderRadius":"0px","background":"none","width":"auto","lineHeight":"34px","fontSize":"14px","height":"34px"}' v-if="btnAuth('users','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"1px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#f53400","borderRadius":"0px","background":"none","width":"auto","lineHeight":"34px","fontSize":"14px","height":"34px"}' v-if="btnAuth('users','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"1px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#f53400","borderRadius":"0px","background":"none","width":"auto","lineHeight":"34px","fontSize":"14px","height":"34px"}' v-if="btnAuth('users','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
