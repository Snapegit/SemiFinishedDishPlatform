...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"0 0 0px","margin":"10px 0 0","borderColor":"#ddd","alignItems":"center","display":"flex","clear":"both","justifyContent":"","flexWrap":"wrap","background":"none","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid","height":"auto","order":"1"}'>
      ...
      <el-form-item :style='{"margin":"0 5px 0 0"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 0 0 0px","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>投票时间：</div>
        <el-date-picker 
          v-model="timeRange"
          type="datetimerange"
          range-separator="至"
          ...
          start-placeholder="投票时间起始"
          end-placeholder="投票时间结束"
	  ...
	  <el-button v-if="btnAuth('toupiaojilu','新增')" :style='{"cursor":"pointer","border":"1px solid #ccc","padding":"0px 8px","margin":"0px 10px 0 0","color":"#666","borderRadius":"4px","background":"#f9f9f9","display":"inline-block","width":"auto","fontSize":"14px","lineHeight":"36px","height":"36px"}' type="primary" @click="add('/index/toupiaojiluAdd')"><i v-if="true" :style='{"color":"#666","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
		...
		<div class="list1 index-pv1" :style='{"padding":"0 0 0 20px","overflow":"hidden","color":"#666","background":"none","width":"100%","fontSize":"14px","height":"auto"}'>
			<div :style='{"border":"0px solid #ddd","cursor":"pointer","padding":"0 0 10px","margin":"0 43px 20px 0","overflow":"hidden","background":"#fff","display":"inline-block","width":"140px","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"0 0px","margin":"0 5px 0 0","display":"inline-block"}'>
				  <span class="icon iconfont icon-geren11" :style='{"margin":"0 0px 0 0","lineHeight":"1.5","fontSize":"inherit","color":"inherit"}'></span>
				  <span class="text" :style='{"color":"#999","lineHeight":"1.5","fontSize":"inherit"}'>{{item.zhanghao}}</span>
				</div>
			</div>
		</div>
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.timeRange.length > 0) {
          searchWhere.toupiaoshijianstart = this.timeRange[0];
          searchWhere.toupiaoshijianend = this.timeRange[1];
        }
			let user = JSON.parse(localStorage.getItem('sessionForm'))
		if (this.sortType) searchWhere.sort = this.sortType
		if (this.sortOrder) searchWhere.order = this.sortOrder
        this.$http.get(`toupiaojilu/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        ...
        this.$router.push({path: '/index/toupiaojiluDetail', query: params});
      },
